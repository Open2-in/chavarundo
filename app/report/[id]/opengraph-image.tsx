...
export default async function OgImage({
  ...
  const address = r?.address ?? "Road Waste Report";
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontSize: 22, color: "#00f0ff", letterSpacing: "2px" }}>Chavarundo?</span>
            <div
              style={{
                display: "flex",
                alignItems: "center",
          ...
          >
            <span style={{ fontSize: 14, color: "rgba(0,240,255,0.3)", letterSpacing: "3px" }}>
              chavarundo.open2.in/report/{id.slice(0, 8)}…
            </span>
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.1)", letterSpacing: "2.5px" }}>
              COMMUNITY WASTE & GARBAGE TRACKER · KERALA
            </span>
          </div>
        </div>
