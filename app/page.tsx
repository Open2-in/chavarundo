  ...
  return (
    <main>
      ...
      <SeoAboutModal>
        ...
        <h1 className="text-2xl font-bold text-emerald-700 dark:text-cyan-400 mb-4">
          Chavarundo — Community Public Waste & Garbage Tracker for Kerala
        </h1>
        <p className="text-emerald-800/80 dark:text-cyan-300/80 text-sm leading-relaxed mb-8">
        ...
        <h2 className="text-lg font-bold text-emerald-700 dark:text-cyan-400 mb-3">How it works</h2>
        <ol className="text-emerald-800/80 dark:text-cyan-300/70 text-sm space-y-2 mb-8 list-decimal list-inside">
        ...
        <h2 className="text-lg font-bold text-emerald-700 dark:text-cyan-400 mb-3">Districts covered</h2>
        <ul className="text-emerald-800/80 dark:text-cyan-300/70 text-sm grid grid-cols-2 gap-1 mb-8">
          {[
            ...
            <li key={d} className="before:content-['▸'] before:text-emerald-500 dark:before:text-cyan-500 before:mr-1">{d}</li>
          ))}
        </ul>

        <h2 className="text-lg font-bold text-emerald-700 dark:text-cyan-400 mb-3">Responsible authority classification</h2>
        <ul className="text-emerald-800/80 dark:text-cyan-300/70 text-sm space-y-1 mb-8">
          <li><span className="text-amber-800 dark:text-yellow-400 font-bold">National Highway / NHAI</span> — Motorway, trunk roads → MP / NHAI</li>
          <li><span className="text-orange-700 dark:text-orange-400 font-bold">State PWD</span> — Primary, secondary roads → MLA / State PWD</li>
          <li><span className="text-green-700 dark:text-green-400 font-bold">Panchayat / Municipality / LSGD</span> — Tertiary roads & local waste collection → Local body</li>
          <li><span className="text-emerald-800 dark:text-cyan-400 font-bold">Ward Member</span> — Residential and unclassified roads</li>
        </ul>

        <h2 className="text-lg font-bold text-emerald-700 dark:text-cyan-400 mb-3">Report public waste in Kerala</h2>
        <p className="text-emerald-800/80 dark:text-cyan-300/70 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-cyan-700 dark:text-cyan-400 mt-12 mb-6">Frequently Asked Questions</h2>
        <div className="flex flex-col gap-6">

          <div>
            <h3 className="text-sm font-bold text-cyan-800 dark:text-cyan-300 mb-1">Do I need to create an account?</h3>
            <p className="text-gray-700 dark:text-cyan-300/60 text-sm leading-relaxed">
          ...
          <div>
            <h3 className="text-sm font-bold text-cyan-800 dark:text-cyan-300 mb-1">What happens after I report?</h3>
            <p className="text-gray-700 dark:text-cyan-300/60 text-sm leading-relaxed">
          ...
          <div>
            <h3 className="text-sm font-bold text-cyan-800 dark:text-cyan-300 mb-1">Who cleans the waste?</h3>
            <p className="text-gray-700 dark:text-cyan-300/60 text-sm leading-relaxed">
          ...
          <div>
            <h3 className="text-sm font-bold text-cyan-800 dark:text-cyan-300 mb-1">Is my data private?</h3>
            <p className="text-gray-700 dark:text-cyan-300/60 text-sm leading-relaxed">
