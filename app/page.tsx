    ...
    <main>
      ...
      <section id="seo-content" className="bg-white dark:bg-black text-black dark:text-white font-mono px-6 py-16 max-w-3xl mx-auto">
        ...
        <p className="text-blue-800/80 dark:text-cyan-300/80 text-sm leading-relaxed mb-8">
          ...
          where residents of Kerala can report, track, and vote on road waste and public garbage dumps
          in their area. Reports include waste segment, severity, photo evidence, and the responsible
        ...
        <ol className="text-blue-800/80 dark:text-cyan-300/70 text-sm space-y-2 mb-8 list-decimal list-inside">
          <li>Tap two points on the map to trace a road waste or garbage segment</li>
          ...
          <li>Community members upvote or dispute reports to surface the most polluted spots</li>
        </ol>
        ...
        <h2 className="text-lg font-bold text-blue-700 dark:text-cyan-400 mb-3">Report road waste in Kerala</h2>
        <p className="text-blue-800/80 dark:text-cyan-300/70 text-sm leading-relaxed">
          Anyone can report road waste on chavarundo.open2.in. Sign in with Google, trace the polluted
          road on the map, and submit. Your report is instantly visible to the community and
          tagged to the correct government authority responsible for the area. Kerala residents
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <p className="text-cyan-300/60 text-sm leading-relaxed">
              ...
              If you sign in with Google, you can draw a waste segment on the map, edit or delete your
